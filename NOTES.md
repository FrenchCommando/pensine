...
- `build-windows.yml` additionally uploads the zip as a workflow artifact on every push/PR so any green build is downloadable without cutting a release. See DEPLOYMENT.md for the user-facing install steps.
