      ...
      content: SingleChildScrollView(child: Column(
        ...
        children: [
          ...
          if (_hasKeyboardShortcuts()) ...[
            ...
            _shortcutRow('S', 'Shake marbles'),
            _shortcutRow('R', 'Reset the board'),
            _shortcutRow('D', 'Toggle dark / light theme'),
            _shortcutRow('A', 'About (this dialog)'),
            _shortcutRow('Ctrl + N', 'New board (home screen)'),
            SizedBox(height: 8),
            Text('Table mode:',
                style: TextStyle(color: PensineColors.muted(context))),
            SizedBox(height: 4),
            _shortcutRow('↑ / ↓', 'Move selection'),
            _shortcutRow('E', 'Edit selected row'),
            _shortcutRow('Enter', 'Activate (same as click)'),
            SizedBox(height: 8),
            Text('Mouse:',
                style: TextStyle(color: PensineColors.muted(context))),
            SizedBox(height: 4),
            _shortcutRow('Right-click', 'Edit marble or row'),
          ],
          if (boardCount > 0) ...[
            SizedBox(height: 12),
            Text(
